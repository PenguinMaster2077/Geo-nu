...
public:
    ...
    void Add_Parameter(std::string Name, Double_t Value, Double_t Error, Int_t Error_Factor, Double_t Value_Min, Double_t Value_Max, Bool_t Constant);
...
//Compute Events
    ...
    //Geo Ratio
        //Set up in Constants_Setting.hh
    //Geo U
